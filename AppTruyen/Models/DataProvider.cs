...
namespace AppTruyen.Models
{
    public class DataProvider
    {
        ...
        public void SetConnectionString(string Host, string Database, string Username, string Password)
        {
            string str_tmp = @"Server="+Host+ ";Database="+Database+ ";UId="+Username+";Pwd="+Password+ ";port=3306;Pooling=false;Character Set=utf8";
            this.strConnection = str_tmp;
            connection = new MySqlConnection(strConnection);
        }
